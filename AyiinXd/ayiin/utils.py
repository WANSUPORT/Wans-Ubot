...
async def autopilot():
    ...
    try:
        r = await bot(
            CreateChannelRequest(
                title="Wans-Userbot Logs",
                about="» Group log Created by: Wans-Userbot\n\n» Support : @Wansupport\n» Support: @Wansupport",
                megagroup=True,
            ),
        )
    ...
    if isinstance(chat.photo, ChatPhotoEmpty):
        photo = await download_file(
            "https://telegra.ph/file/32fa31f487fd1e3828eec.jpg", "photoyins.jpg"
        )
...
async def autobot():
    ...
    if isdone.startswith("Sorry,"):
        ...
        if nowdone.startswith("Done!"):
            ...
            await bot.send_message(bf, f"@{username}")
            await asyncio.sleep(1)
            await bot.send_file(bf, "AyiinXd/resources/Picsart_22-06-11_23-53-46-896.jpg")
            await asyncio.sleep(3)
